...
Training metrics are automatically logged by TrainingLogger:
...
Logs saved to: `/datasets/marauder-do-bucket/training/logs/shore_ensemble/`
Metrics file: `/datasets/marauder-do-bucket/training/logs/shore_ensemble/metrics.json`
...
- Check the logs: `/datasets/marauder-do-bucket/training/logs/shore_ensemble/`
- Review metrics: `cat /datasets/marauder-do-bucket/training/logs/shore_ensemble/metrics.json | jq .`
